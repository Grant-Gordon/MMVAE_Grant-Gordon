...
#NOTE: CONFIG_NAME only used for TRAIN_CONFIG_FILE which is currently unsused (See other note at TRAIN_CONFIG_FILE)
...
#NOTE: TRAIN_CONFIG_FILE only called for meta_descriminator rule atm (2025/1/30) whcih is commented out
